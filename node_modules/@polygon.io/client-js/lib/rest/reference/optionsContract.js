...
const optionsContract = (apiKey, apiBase, optionsTicker, query, headers) => (0, request_1.get)(`/v3/reference/options/contracts/${optionsTicker}`, apiKey, apiBase, query, headers);
