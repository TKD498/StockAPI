...
export declare const optionsContract: (apiKey: string, apiBase: string, optionsTicker: string, query?: IOptionsContractQuery, headers?: IHeaders) => Promise<IOptionsContract>;
