...
import { IForexQuotes } from "./quotes";
...
export interface IForexClient {
    ...
    quotes: (fxTicker: string, query?: ITradesQuotesQuery) => Promise<IForexQuotes>;
...
export declare const forexClient: (apiKey: string, apiBase?: string, headers?: IHeaders) => IForexClient;
